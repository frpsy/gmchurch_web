    ...
    anglican: {
        ...
        korea: {
            ...
            paras: [
                ...
                "일제강점기와 민주화 운동 시기에도 사회적 약자와 함께했으며, 오늘날에도 선교·교육·사회복지 사업을 통해 하느님 나라를 이 땅에 이루어 가고 있습니다."
            ],
            highlights: [
    ...
    clergy: [
        {
            ...
            bio: {
                ...
                ministryNote: "대한성공회 최초로 반려동물 축복식을 시작해 12년째 이어오고 있으며 유기견 보호소 봉사, 수의사 초청 강연 등 생명 존중 사역을 이어가고 있습니다. '경계가 없는 교회, 모든 생명에게 열려 있는 교회, 차별과 혐오에 맞서는 교회' — 민숙희 사제가 평생 가꾸어 온 사목의 비전입니다.",
                source: {
