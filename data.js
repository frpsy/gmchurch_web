...
const CHURCH_DATA = {
    ...
    anglican: {
        ...
        what: {
            ...
            title: "성공회란?",
            paras: [
                "성공회(聖公會)는 '거룩하고 공번된 교회'라는 뜻입니다. 16세기 잉글랜드 종교개혁을 통해 초대 교회의 순수성을 회복하려 한 성공회는 가톨릭의 풍부한 전례 전통과 개신교의 성서 중심 신앙을 함께 품는 <strong>'중도의 길(Via Media)'</strong>을 걸어왔습니다.",
        ...
        korea: {
            ...
            paras: [
                ...
                "일제강점기와 민주화 운동 시기에도 사회 참여를 이어왔으며, 현재 선교·교육·사회복지 사업을 운영하고 있습니다."
            ],
            highlights: [
    ...
    logo: {
        eyebrow: "Our Symbol",
        title: "캔터베리 십자가",
        desc: "성공회의 상징인 캔터베리 십자가(Canterbury Cross)는 전 세계 165개국 1억 명의 성공회 공동체를 하나로 잇는 심볼입니다. 9세기 영국 캔터베리에서 발굴된 앵글로색슨 브로치에서 유래했으며, 성공회의 보편성과 연대 정신을 나타냅니다.",
    ...
    clergy: [
        {
            ...
            desc: "성공회대학교 신학과(1988학번)를 졸업하고 2005년 사제 서품을 받았습니다. 2025년 3월에는 대한성공회 서울교구 최초의 여성 총사제로 임명되었습니다. 성평등한 교회, 녹색교회를 지향하며 광명교회를 섬기고 있습니다.",
        ...
        main: [
            {
                ...
                desc: "성공회 전례의 핵심인 감사성찬례(Eucharist). 말씀과 성찬으로 오시는 예수 그리스도를 만나는 시간입니다. 모든 세례 교인이 성체를 받을 수 있으며, 처음 오신 분도 환영합니다."
            },
            {
                id: "children",
                title: "어린이 예배",
    ...
    giving: {
        ...
        receiptInfo: "헌금하신 내역은 기부금 영수증 발급이 가능합니다. 기부금 영수증이 필요하시면 교회 사무실로 문의 주세요."
    },
