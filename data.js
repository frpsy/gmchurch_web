...
const CHURCH_DATA = {
    ...
    anglican: {
        welcome: "성공회의 역사와 신앙, 광명교회의 사제단과 사목 방향을 소개합니다.",
        what: {
            eyebrow: "Anglican Church",
            title: "성공회란?",
            paras: [
                "성공회(聖公會)는 '거룩하고 공번된 교회'라는 뜻입니다. 16세기 잉글랜드 종교개혁에 뿌리를 두며, 가톨릭의 풍부한 전례 전통과 개신교의 성서 중심 신앙을 함께 품는 <strong>'중도의 길(Via Media)'</strong>을 걸어왔습니다.",
                "오늘날 성공회는 전 세계 165개국, 약 1억 명의 신자를 두는 세계 공동체입니다. 특정 교리를 강요하거나 한 지도자에게 권위를 집중하지 않으며, <strong>말씀과 성찬을 중심으로 한 공동 신앙</strong>을 원칙으로 삼습니다."
            ],
            pillars: [
        ...
        korea: {
            ...
            founded: "1890",
            paras: [
                "1890년, 영국 성공회 선교사 찰스 존 코프(Charles John Corfe) 주교가 한국에 첫발을 내딛으면서 대한성공회의 역사가 시작되었습니다. 선교 초기부터 병원과 학교를 세워 몸과 마음을 함께 돌보는 통전적 선교를 실천해 왔습니다.",
                "일제강점기와 민주화 운동 시기에도 사회 참여를 멈추지 않았으며, 오늘날에도 선교·교육·사회복지 분야에서 활동을 이어가고 있습니다."
            ],
            highlights: [
    ...
    logo: {
        eyebrow: "Our Symbol",
        title: "캔터베리 십자가",
        desc: "캔터베리 십자가(Canterbury Cross)는 전 세계 165개국, 약 1억 명의 성공회 공동체를 하나로 잇는 상징입니다. 9세기 영국 캔터베리에서 발굴된 앵글로색슨 브로치에서 유래했으며, 성공회의 보편성과 연대 정신을 담고 있습니다.",
        colors: "짙은 녹색은 생명과 성장, 흰색 십자가는 그리스도의 빛과 희망을 상징합니다."
    },
    ...
    clergy: [
        {
            ...
            desc: "성공회대학교 신학과(1988학번)를 졸업하고 2005년 사제 서품을 받았습니다. 2025년 3월에는 서울교구 최초의 여성 총사제로 임명되었습니다. 성평등하고 생태를 존중하는 교회를 지향하며 광명교회를 섬기고 있습니다.",
            ...
            bio: {
                ...
                ministryNote: "대한성공회 최초로 반려동물 축복식을 시작해 12년째 이어오고 있으며, 유기견 보호소 봉사·수의사 초청 강연 등 생명 사역을 병행하고 있습니다. '경계 없는 교회, 모든 생명에게 열린 교회, 차별과 혐오에 맞서는 교회' — 민숙희 사제의 사목 방향입니다.",
                source: {
        ...
        },
        {
            ...
            ordained: "",
            quote: "",
            desc: "연세대 불어불문학과를 졸업하고 36세에 성공회대 신학과에 편입해 성직자가 되었습니다. 가톨릭대학교 상담심리대학원에서 상담심리석사 학위와 상담심리사 자격을 취득하였으며, 동방문화대학원대학교에서 주역·명리학을 전공하고 철학박사 학위를 받았습니다. 성공회대학교 및 한겨레문화센터에서 강의하였고, 현재 옹진 재가노인지원서비스센터장과 광명교회 협동사제로 섬기고 있습니다.",
            contact: "",
        ...
        values: [
            {
                icon: "🌿",
                title: "녹색 교회",
                desc: "생태 환경을 신앙의 과제로 삼고 실천합니다."
            },
            {
                icon: "🤲",
                title: "열린 교회",
                desc: "동물·성소수자·장애인·외국인 등 사회적 소수자를 포함한 모두에게 열려 있습니다."
            },
            {
                icon: "⚖️",
                title: "평등한 교회",
            ...
            },
            {
                icon: "✝️",
                title: "전례 중심",
                desc: "성공회 기도서에 따른 전례와 성찬례를 예배의 중심으로 삼습니다."
            }
        ]
    },
    ...
    worship: {
        ...
        main: [
            ...
            },
            {
                ...
                title: "어린이 예배",
                time: "매주 일요일 오전 11:00",
                desc: "교육관에서 진행하는 어린이 대상 예배입니다. 성공회 전례를 어린이 눈높이에 맞춰 구성합니다."
            }
        ],
        guide: "",
        liturgyInfo: [
        ...
        groups: [
            {
                id: "hopecenter",
                title: "광명 희망터",
                desc: "광명 지역 소외 이웃과 함께하는 나눔과 돌봄의 사역입니다.",
                icon: "🌱",
            ...
            },
            {
                id: "smallgroup",
                title: "소그룹 모임",
                desc: "소규모 모임 안에서 말씀을 함께 나누고 신앙을 서로 돌봅니다.",
                icon: "🤝",
    ...
    giving: {
        ...
        bank: "2680-100-14008",
        holder: "대한성공회 광명교회",
        report: "분기별 사역 재정 보고를 공개합니다.",
        receiptInfo: "헌금하신 내역에 대해 기부금 영수증을 발급받으실 수 있습니다. 영수증이 필요하시면 교회 사무실로 문의해 주세요."
    },
