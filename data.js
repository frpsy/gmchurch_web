...
const CHURCH_DATA = {
    ...
    logo: {
        ...
        letters: [
            ...
            { letter: "C", word: "Church", desc: "교회 — 공번된(Catholic) 신앙 공동체" },
            { letter: "G", word: "Gwangmyeong", desc: "광명(光明) — 우리가 자리한 도시이자 비추고자 하는 빛" }
        ],
        colors: "짙은 녹색은 성공회 전통과 생명, 흰색은 빛과 개방성을 나타냅니다."
    },
        ...
        main: [
            {
                ...
                desc: "성공회 전례의 핵심인 감사성찬례(Eucharist). 말씀 전례와 성찬 전례로 이루어지며, 세례 교인은 영성체에 참여합니다."
            },
            {
                id: "children",
                title: "어린이 예배",
    ...
    community: {
        groups: [
            ...
            },
            {
                id: "emmaus",
                title: "엠마우스 코스",
                desc: "성공회 신앙 기초 교육 과정. 전례의 의미와 교회 언어를 다룹니다.",
                icon: "📖"
            },
            {
                id: "smallgroup",
