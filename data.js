        ...
        },
        {
            ...
            bio: {
                milestones: [
                    ...
                    { year: "35세", text: "성공회대학교 신학과 편입 — 늦깎이로 사제의 길을 선택" },
                    { year: "—", text: "사제 서품" },
                    { year: "45세", text: "가톨릭대학교 상담심리대학원 상담심리학 석사 수료, 상담심리사 자격 취득" },
                    { year: "—", text: "마포들음교회 관할사제 — 교회 내 들음상담센터 개설·운영" },
                    { year: "—", text: "동방문화대학원대학교 주역·명리학 철학박사 취득" },
        ...
        main: [
            {
                ...
                desc: "성공회 전례의 중심인 감사성찬례(Eucharist)입니다. 말씀과 성찬 안에서 예수 그리스도를 만나는 시간이며, 세례받은 모든 그리스도인이 성체를 모실 수 있습니다. 반려동물들도 함께 예배드릴 수 있으며, 영성체 시간에 데리고 나오시면 신부님의 강복을 받을 수 있습니다."
            },
            {
                id: "children",
                title: "어린이 예배",
