...
const CHURCH_DATA = {
    ...
    anglican: {
        ...
        what: {
            ...
            mission: {
                ...
                title: "성공회 선교정신",
                intro: "성공회는 그리스도를 따르는 선교 공동체로서, ‘교회의 선교는 그리스도의 선교(The Mission of the Church is the Mission of Christ)’라는 고백 위에 서 있습니다.",
                marks: [
    ...
    logo: {
        ...
        desc: "세계성공회 공동체를 하나로 잇는 상징으로, 1867년 영국 캔터베리에서 발굴된 9세기 앵글로색슨 브로치에서 유래했습니다. 원형 디자인 안에 복음과 삼위일체, 세계 교회의 연대라는 성공회 신앙의 핵심이 담겨 있습니다.",
    ...
    worship: {
        ...
        nextReadings: {
            ...
            date: "2026년 7월 19일",
            items: [
                { role: "제1독서", ref: "이사야 44:6-8" },
                { role: "시편", ref: "시편 86:11-17" },
        ...
        main: [
            ...
            },
            {
                ...
                verseRef: "마태 18:3",
                detail: "주일학교 선생님들과 해당 주일 전례독서에 따라 찬양과 말씀 관련 활동을 하고, 영성체 시간에 어른들과 함께 영성체를 합니다. 세례받은 모든 어린이는 성체(흰색 밀 면병)를 받고, 성혈(무알코올 포도즙)을 받을 수 있습니다."
            }
        ],
        guide: "",
        ...
        prayer: {
            dailyOfficeIntro: [
                "성무일과(매일기도)는 정해진 시간에 드리는 교회의 공적 기도입니다. \"늘 기도하십시오\"(1데살 5:17)라는 말씀을 따라, 초대교회와 수도원 전통에서 이어져 온 기도의 리듬입니다.",
                ...
                sections: [
                    {
                        ...
                        body: [
                            ...
                            "잉글랜드 종교개혁기에 토마스 크랜머 캔터베리 대주교가 성서와 개신교 교리에 입각해서 동서고금의 훌륭한 기도문과 예식문들을 참고하면서도, 영국의 평민들(commoners) 모두가 가정에 두고 즐겨 사용하도록 편찬했습니다. 그래서 영문학상으로도 중요한 자료로 평가됩니다.",
    ...
    media: {
        ...
        videos: [
            ...
            },
            {
                id: "9gah5PrWiWk",
                title: "광명교회 주일 애찬 풍경",
                desc: "주일 감사성찬례가 끝난 후, 성도들이 함께 모여 밥을 나누는 애찬 시간을 담은 영상입니다.",
                category: "공동체"
            },
            {
                id: "HhG_WUnRbPA",
        ...
        categories: [
            {
                ...
                items: [
                    {
                        q: "성공회는 이단인가요?",
                        a: "아닙니다. 현재 세계 165개국, 약 8,500만 명 이상의 신자들이 캔터베리 대주교와 상징적 관계를 맺고 자치하고 있는 그리스도교 전통에 뿌리를 둔 교단입니다.\n\n16세기 종교개혁으로 로마가톨릭을 믿던 서유럽은 분열됩니다. 독일과 북유럽은 종교개혁가 마르틴 루터를 따르는 루터교가 국가교회로 설립되었고, 스위스와 프랑스 일부, 스코틀랜드에는 장 칼뱅을 따르는 장로교가 생겼습니다. 잉글랜드는 국왕 헨리 8세가 로마 교황을 거부하면서 국교회의 수장이 되면서 성공회가 생겨났습니다. 지금도 국왕이 잉글랜드 국교회의 수장이지만, 상징에 불과합니다.",
                        refs: [
        ...
        specialSundays: [
            {
                ...
                date: "1월 6일 또는 직후 주일",
                origin: "세계성공회",
                desc: "동방박사들의 방문을 통해 예수님이 온 세상에 드러나신 날입니다. 공현절 후 첫 주일은 주님의 세례 주일로 지킵니다."
            },
            {
                name: "세계기도일",
            ...
            },
            {
                ...
                date: "성령강림 다음 주일",
                origin: "세계성공회",
                desc: "성부·성자·성령 삼위일체 하느님을 고백하는 날. 성공회 교회력에서 특별히 강조하는 교리 주일입니다."
            },
            {
                name: "환경주일",
                ...
                date: "6월 첫째 주일",
                origin: "NCCK · 대한성공회",
                desc: "하느님의 창조세계를 돌보는 청지기 사명을 새기는 날. 한국교회가 함께 지켜 왔습니다."
            },
            {
                name: "창조절",
